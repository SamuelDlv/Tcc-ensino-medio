...
$labIDs = [1, 2, 3, 4]; // laboratórios disponíveis para o professor
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
    <div class="app-shell">
        <?php renderTopbar('professor', 'inicio'); ?>
        <main class="app-main">
            <div class="page-head">
                <h1>Laboratórios</h1>
            ...
            <div class="lab-grid">
                ...
                ?>
                    <div class="lab-card">
                        ...
                        <a class="btn btn-accent btn-block" href="/professor/laboratorio.php?lab=<?= $labID ?>">Entrar</a>
                    </div>
                <?php endforeach; ?>
            </div>
        </main>
